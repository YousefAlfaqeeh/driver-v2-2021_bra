...
public class DBHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "driver_offline";
    // Contacts table name
    private static final String TABLE_SHOPS = "driver";
    ...
    public void addShop() {
        ...
        values.put(KEY_NAME, "123"); // Shop Name
        values.put(KEY_AGE, "123"); // Shop Phone Number
// Inserting Row
